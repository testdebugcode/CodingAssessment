...
public class AmazonDeliveryPage  extends BasePage {
	...
	public AmazonDeliveryPage getItemDesc() {
		...
		checkoutItemDesc=getTextOfElement(getMobileElement("xpath", "//android.widget.TextView[contains(@text,'HD')]"));
		return this;
	...
	public AmazonDeliveryPage getItemPrice() {
		checkoutPriceValue=getTextOfElement(getMobileElement("xpath", "(//android.widget.TextView[contains(@text,'00')])[2]"));
		return this;
	}
